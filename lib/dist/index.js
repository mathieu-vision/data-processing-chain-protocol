...
__export(src_exports, {
  ...
  setReportingCallbacks: () => setReportingCallbacks,
...
((NodeSignal2) => {
  ...
  NodeSignal2.CHAIN_SETUP = "chain_setup";
})(NodeSignal || (NodeSignal = {}));
...
var _ReportingAgent = class _ReportingAgent extends Agent {
  constructor() {
    super();
    this.signals = [];
    if (!(_ReportingAgent.authorizedAgent instanceof Agent)) {
      throw new Error(
        "Node Reporter needs to be instantiated by an authorized Agent"
      );
    }
    _ReportingAgent.authorizedAgent = null;
  }
  static authorize(agent) {
    _ReportingAgent.authorizedAgent = agent;
  }
  notify(signal) {
...
_ReportingAgent.authorizedAgent = null;
var ReportingAgent = _ReportingAgent;

// src/agents/MonitoringAgent.ts
var NodeReportingAgent = class extends ReportingAgent {
...
var MonitoringAgent = class _MonitoringAgent extends Agent {
  constructor() {
    super();
    this.reportings = /* @__PURE__ */ new Map();
  ...
  genReporterAgent(chainId, nodeId) {
...
var defaultMonitoringResolver = (meta) => __async(void 0, null, function* () {
  try {
    Logger.info({
      message: `Resolving host for monitoring meta: ${JSON.stringify(meta, null, 2)}`
    });
    if ((meta == null ? void 0 : meta.monitoringHost) !== void 0) {
      return meta == null ? void 0 : meta.monitoringHost;
...
var setReportingCallbacks = (dcPayload) => __async(void 0, null, function* () {
