...
((NodeSignal3) => {
  ...
  NodeSignal3.NODE_ERROR = "node_error";
  NodeSignal3.NODE_RESUME = "node_resume";
  NodeSignal3.NODE_STOP = "node_stop";
      ...
      this.executionQueue = this.executionQueue.then(() => __async(this, null, function* () {
        ...
        try {
          ...
          if (isResuming && suspendedState) {
            generator = suspendedState.generator;
            processingData = suspendedState.data;
            yield this.processBatch(suspendedState.currentBatch, processingData);
            const postBatchStatus = yield this.statusManager.process();
          ...
          while (!nextResult.done) {
            const preProcessStatus = yield this.statusManager.process();
            ...
            yield this.processBatch(nextResult.value, processingData);
            nextResult = generator.next();
            const postProcessStatus = yield this.statusManager.process();
          ...
          if ((_a2 = this.config) == null ? void 0 : _a2.chainConfig) {
            ...
            yield this.processChildChain(processingData);
          }
        } catch (error) {
